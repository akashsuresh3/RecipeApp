...
class LocalData @Inject constructor(val context: Context) {
    ...
    fun doLogin(loginRequest: LoginRequest): Resource<LoginResponse> {
        if (loginRequest == LoginRequest("akash@akash.akash", "akash")) {
            return Resource.Success(LoginResponse("123", "Akash", "PS",
                    "FrunkfurterAlle", "77", "12000", "Berlin",
                    "Germany", "akash@akash.akash"))
        }
    ...
    fun createRecipe(createRecipe: CreateRecipeRequest): Resource<Boolean> {
